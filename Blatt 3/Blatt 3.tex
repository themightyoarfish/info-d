...
\begin{document}
   ...
   \begin{tabular}{M|M|M|M|M}
      ...
      \cellcolor{Red!5} 1 & \varepsilon \mid (a\x{}^*ca)^* & \cellcolor{Blue!5} (a\x{}^*ca)^*b & a\x{}^*(c\y{}\x{}^*)^* & \cellcolor{Blue!5} a\x{}^*c(\y{}\x{}^*c)^* \\ \hline
      2 & \emptyset & \varepsilon & \emptyset & \emptyset \\ \hline
      3 & \x{}^*ca(a\x{}^*ca)^* & \x{}^*(\x{}^*c\y{})^*c\z{} & \varepsilon \mid
      \x{}^*(c\y{}\x{}^*)^*& \x{}^*c(\y{}\x{}^*c)^*\\ \hline
      4 & a(a\x{}^*ca)^* & (\y{}\x{}^*c)^*\z{} & \y{}\x{}^*(c\y{}\x{}^*)^* & \varepsilon \mid (\y{}\x{}^*c)^*
   \end{tabular}
   }
   \vspace{\baselineskip}
