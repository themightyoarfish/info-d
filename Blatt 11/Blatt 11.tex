...
\begin{enumerate}
   ...
   \item Für jede Klausel in $\mathcal{F}$ mit zwei Literalen $x_i, x_j$, kreiere eine
      Klausel
      \begin{equation*}
         [[x_i \vee a]] \wedge [[x_j \vee b]] \wedge [[a \vee b]],
      \end{equation*} wobei $a, b$ neue Variablen sind
